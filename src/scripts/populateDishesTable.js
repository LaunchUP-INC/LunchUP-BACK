  ...
  try {
    const dishes = [
      ...
      },
      {
        ...
        description:
          "Ensalada refrescante y nutritiva preparada con quinoa, mezclada con verduras asadas como pimientos, calabacines y berenjenas, aliñada con aceite de oliva, limón y hierbas frescas.",
        price: 130,
        images: [
      ...
      },
      {
        ...
        description:
          "Tarta preparada con masa casera rellena de jamón cocido, queso y crema.",
        price: 150,
        images: [
      ...
      },
      {
        ...
        description:
          "Guiso casero preparado con lentejas, zanahorias, cebolla y pimientos, condimentado con comino y laurel.",
        price: 230,
        images: [
      ...
      },
      {
        ...
        description:
          "Sándwich emparedado con jamón y queso dentro de dos rebanadas de pan. Se sirve tostado, tras untarlo con mantequilla.",
        price: 120,
        images: [
      ...
      },
      {
        ...
        description:
          "Sopa caliente y reconfortante preparada con una variedad de verduras frescas y caldo casero.",
        price: 200,
        images: [
